...
import payInStoreImg from '../assets/images/pay-monthly.webp'
            ...
            <div className="pay-in-4__panel">
              ...
              <div className="pay-in-4__bottom">
                <p className="pay-in-4__desc">
                  Paid every two weeks. No late fees. Won&rsquo;t affect your
                  credit score to apply.<sup>4</sup>
                </p>
                <button type="button" className="pay-in-4__btn">Learn About Pay in 4</button>
              </div>
            </div>
            <div
          ...
          <div className="container pay-in-4__inner">
            <div className="pay-in-4__panel pay-in-4__panel--blue">
              ...
              <div className="pay-in-4__bottom">
                <p className="pay-in-4__desc">
                  With $0 down.<br />
                  No sign-up fees or late fees.<sup>5</sup>
                </p>
                <button type="button" className="pay-in-4__btn pay-in-4__btn--dark">
                  Learn About Pay Monthly
                </button>
              </div>
            </div>
            <div
        ...
        <section className="pay-in-4 pay-in-store pay-stack__item">
          <div className="container pay-in-4__inner">
            <div className="pay-in-4__panel pay-in-4__panel--gray">
              ...
              <div className="pay-in-4__bottom">
                <p className="pay-in-4__desc">
                  Buy an item you&rsquo;d like to purchase now but would
                  prefer to pay for over time.
                </p>
                <button type="button" className="pay-in-4__btn pay-in-4__btn--dark">
                  Learn About Pay Monthly In Store
                </button>
              </div>
            </div>
            <div
